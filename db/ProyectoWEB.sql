...
START TRANSACTION;
USE `proyectoWEB`;
INSERT INTO `proyectoWEB`.`usuarios` (`id`, `name`, `password`, `admin`) VALUES (1, 'admin', 'adminadmin', true);
INSERT INTO `proyectoWEB`.`usuarios` (`id`, `name`, `password`, `admin`) VALUES (2, 'cliente', 'cliente123', false);
