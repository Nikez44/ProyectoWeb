...
START TRANSACTION;
USE `proyectoWEB`;
INSERT INTO `proyectoWEB`.`usuarios` (`id`, `name`, `apellido`, `email`, `password`, `admin`) VALUES (1, 'admin', DEFAULT, DEFAULT, 'adminadmin', true);
INSERT INTO `proyectoWEB`.`usuarios` (`id`, `name`, `apellido`, `email`, `password`, `admin`) VALUES (2, 'cliente', DEFAULT, DEFAULT, 'cliente123', false);
...
START TRANSACTION;
USE `proyectoWEB`;
INSERT INTO `proyectoWEB`.`juegos` (`id`, `nombre`, `precio`, `cantidad`, `categoria_id`, `consola_id`) VALUES (1, 'Mortal Kombat X', 799.99, 20, 1, 4);
INSERT INTO `proyectoWEB`.`juegos` (`id`, `nombre`, `precio`, `cantidad`, `categoria_id`, `consola_id`) VALUES (2, 'Gears of War 3', 599.99, 40, 5, 3);
